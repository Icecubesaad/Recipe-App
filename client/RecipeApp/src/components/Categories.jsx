...
const Categories = () => {
  const location = useLocation()
    ...
    const {getDishes,Dishes, handleBackClickMenu, handleNextClickMenu,startIndexMeny,setstartIndexMeny,Menu} = context
    ...
    return (
        ...
        <div className="button-div">
          {startIndexMeny > 0 ? (
              <button onClick={handleBackClickMenu} className="btn-menu">
        ...
        <div className="button-div">
        {startIndexMeny+6>=Menu_length ? <button className="btn-menu" style={{opacity:"0"}}>
        <xml version="1.0" encoding="utf-8" />
        <svg
          width="40px"
          height="40px"
        ...
        <button onClick={handleNextClickMenu} className="btn-menu">
          <xml version="1.0" encoding="utf-8" />
          <svg
            width="40px"
            height="40px"
